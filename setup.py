...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml']),
        #(os.path.join('lib/python3.10/site-packages/b3rb_ros_line_follower'), glob('*.pt')),
        (os.path.join('lib/python3.10/site-packages/', package_name), glob(os.path.join(package_name,'*.pt'))),
    ],
